...
from api.models import PersonalData, SkillCategory, Experience, Project, Achievement
...
def seed():
    ...
    pd = PersonalData(
        ...
        about_values=["Innovation", "Scalability", "User Experience", "Reliability"],
        email="aniket.verma@example.com",
        linkedin="https://linkedin.com/in/aniketverma11",
        github="https://github.com/aniketverma11",
        resume_url="/aniket-resume.pdf"
    )
    pd.save()
    print("Created Personal Data.")
    ...
    for s in skills_data:
        SkillCategory.objects.create(name=s['category'], items=s['items'])
